    ...
    <section id="newsletter" className="py-24">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-primary text-primary-foreground rounded-organic p-12 md:p-16 relative overflow-hidden">
            ...
            <div className="relative z-10 text-center space-y-8">
              <div className="space-y-4">
                <div className="inline-flex items-center justify-center w-20 h-20 bg-white/20 rounded-organic mb-6">
                  ...
                  <div className="flex gap-4">
                    <div className="flex-1">
                      <Input
                        ...
                        className="newsletter-input h-12 text-foreground placeholder:text-muted-foreground border-white/20"
                        disabled={isLoading}
                      />
                    </div>
                    <Button
                      ...
                      size="lg"
                      disabled={isLoading}
                      className="btn-organic bg-background text-primary hover:bg-background/90 h-12 px-6"
                    >
                      {isLoading ? (
              ...
              <div className="border-t border-white/20 pt-8">
                <h4 className="text-lg font-semibold mb-6">What you'll get:</h4>
